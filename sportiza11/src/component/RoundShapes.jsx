  ...
  return (
    <div className="round-shapes-container">
      <div className="round-shape">
        ...
        <p>Sign Up Or Log In Your <br />Free Sportiza 11 Account.</p>
      </div>
      <div className="arrow">
      ...
      <div className="round-shape">
        ...
        <p>Create Your Dream Team <br />From Each Two teams.</p>
      </div>
      <div className="arrow">
        <img src={Arrow} alt="Arrow" />
      </div>
      <div className="round-shape">
        ...
        <p>Win Your Prize & Withdraw <br />Whenever You Can.</p>
      </div>
    </div>
  );
};
